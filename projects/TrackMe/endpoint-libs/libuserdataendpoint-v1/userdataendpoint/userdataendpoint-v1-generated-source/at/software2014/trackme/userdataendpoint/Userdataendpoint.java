...
public class Userdataendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public UpdateLocation updateLocation(java.lang.String email, java.lang.Double latitude, java.lang.Double longitude) throws java.io.IOException {
    UpdateLocation result = new UpdateLocation(email, latitude, longitude);
    initialize(result);
    return result;
  }
  ...
  public class UpdateLocation extends UserdataendpointRequest<Void> {
    ...
    private static final String REST_PATH = "void/{email}/{latitude}/{longitude}";
     ...
     * @since 1.13
     */
    protected UpdateLocation(java.lang.String email, java.lang.Double latitude, java.lang.Double longitude) {
