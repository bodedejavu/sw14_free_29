 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "joanneum.at", ownerName = "joanneum.at", packagePath="gcmtest"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyAgcXpQCFEhLcb0lRjEWtBJ6uBEiS1tbjE";
